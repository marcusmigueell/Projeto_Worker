...
import { GetTimeWorkersController } from "../controllers/workers/GetTimeWorkersController";
...
routes  
    .route("/timeWorker")
    .get(new GetTimeWorkersController().handle)
    .post(new GetTimeWorkersController().handle);
